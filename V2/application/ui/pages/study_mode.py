...
THEME_MAP = {
    "happy": {
        "bg": "#fff4e6",       # soft peach pastel
        "text": "#3e2723",     # grounded brown
        "sidebar": "#ffe0b2"   # gentle orange accent (supportive warmth)
    },
    "surprise": {
        "bg": "#e8f5e9",       # mint pastel (fresh + curious)
        "text": "#1b5e20",     # dark green (grounded curiosity)
        "sidebar": "#c8e6c9"   # calm leafy tone
    },
    "sad": {
        "bg": "#e3f2fd",       # soft sky blue
        "text": "#0d47a1",     # strong blue (energizing clarity)
        "sidebar": "#bbdefb"   # bright pastel blue for lightness
    },
    "angry": {
        "bg": "#fbe9e7",       # warm dusty rose (soothing)
        "text": "#4e342e",     # muted brown (earthy grounding)
        "sidebar": "#ef9a9a"   # faded coral (gentle release)
    },
    "neutral": {
        "bg": "#f5f5f5",       # light grey (balanced neutral)
        "text": "#263238",     # deep blue-grey (focus)
        "sidebar": "#e0e0e0"   # consistent tone for stability
    },
    "tired": {
        "bg": "#ede7f6",       # lavender pastel (relaxing)
        "text": "#311b92",     # deep indigo (night calm)
        "sidebar": "#d1c4e9"   # muted lilac support
    },
    "fear": {
        "bg": "#e8eaf6",       # periwinkle pastel (comforting)
        "text": "#1a237e",     # dark navy (strength)
        "sidebar": "#c5cae9"   # soft bluish support
    },
    "disgust": {
        "bg": "#f3f5e1",       # sage pastel (clean calm)
        "text": "#33691e",     # dark olive green (earthy realism)
        "sidebar": "#dce775"   # muted yellow-green (fresh reset)
    }
}
