...
class DecisionEngine:
    ...
    def get_theme(self, mood):
        ...
        themes = {
            "focused": {"bg": "#1e2a1f", "sidebar": "#253a25", "text": "#a9d6a9"},
            "relaxed": {"bg": "#1b2b38", "sidebar": "#243b4a", "text": "#a3cbe3"},
            "distracted": {"bg": "#2e2a1e", "sidebar": "#3b3526", "text": "#d1b897"},
            "stressed": {"bg": "#2b1e1e", "sidebar": "#3a2626", "text": "#e6a5a5"},
            "neutral": {"bg": "#1e1e1e", "sidebar": "#2b2b2b", "text": "#cccccc"}
        }
